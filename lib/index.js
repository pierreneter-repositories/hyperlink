...
module.exports = function (options) {
    ...
    function tryConnect(url, relations, attempt) {
        ...
        return function (callback) {
          if (options.verbose) {
                console.log('Start try connect url: ' + url)
            }

            var req = (isTls ? tls : net);
            req.setTimeout(timeout);
            req.connect(port, hostname, function () {
    ...
    function httpStatus(url, relations, attempt) {
        ...
        return function (callback) {
            if (options.verbose) {
                console.log('Start checking http status url: ' + url)
            }
